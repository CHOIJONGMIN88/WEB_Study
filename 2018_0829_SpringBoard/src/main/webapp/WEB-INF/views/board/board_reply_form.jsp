...
<table width="750" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<input type="image" src="../img/btn_reg.gif" onClick="send_check(this.form); return false;" style="cursor:hand">
		<img src="../img/btn_back.gif" onClick="location.href='list.do'" style="cursor:hand"></td>
	</tr>
</table>
